...
* mtBakerParser.py - parses Mt. Baker data as well as SNOTEL data and plots it. Requires a specific directory structure to function. More details in that folder.
* graphIButtonData - graphs specifically iButton data. Requires a folder as well, specified in that folder.
